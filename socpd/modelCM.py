...
#comma
from .agentCM import Individual2D, Individual3D, Populating
from .hypothesis import Hypothesis
 

class SocPD_2D(Model, Hypothesis):  
    def setup(self) :
        ...
        self.agents = AgentList(self, pop, Individual2D)
...
class SocPD_3D(Model, Hypothesis):  
    def setup(self) :
        ...
        self.agents = AgentList(self, pop, Individual3D)
        #__generate features then update agent's features and status
        # Specifying use_ipf
